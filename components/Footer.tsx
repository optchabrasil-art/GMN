...
export function Footer() {
  return (
    <footer className="bg-[#f8f9fa] pt-12 sm:pt-16 pb-8 border-t border-gray-200">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12">
        {/* Social Links */}
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mb-8 sm:mb-12 pb-6 sm:pb-8 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link href="#" className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors">
              ...
              <div className="w-4 h-4 sm:w-5 sm:h-5 bg-[#5f6368] rounded-sm" />
            </Link>
            <Link href="#" className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors">
              <Twitter className="w-4 h-4 sm:w-5 sm:h-5 text-[#5f6368]" />
            </Link>
            <Link href="#" className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors">
              <Youtube className="w-4 h-4 sm:w-5 sm:h-5 text-[#5f6368]" />
            </Link>
            <Link href="#" className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors">
              <Facebook className="w-4 h-4 sm:w-5 sm:h-5 text-[#5f6368]" />
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
          {footerLinks.map((column, idx) => (
            <div key={idx}>
              <h4 className="font-bold text-[#3c4043] mb-4 sm:mb-6">{column.title}</h4>
        ...
        <div className="text-xs text-[#5f6368] mb-6 sm:mb-8 text-center sm:text-left">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between pt-6 sm:pt-8 border-t border-gray-200 gap-6">
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6">
            <Link href="/" className="text-lg font-bold text-[#5f6368] tracking-tight mr-0 sm:mr-2">
              Logo
            </Link>
