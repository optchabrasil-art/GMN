...
const steps = [
  {
    number: "1",
    title: "Reivindicar",
    description: "Assuma o controle do seu negócio no Google. É rápido e garante que suas informações estejam seguras."
  },
  {
    number: "2",
    title: "Personalizar",
    description: "Adicione o horário de funcionamento, fotos e outros detalhes para que clientes próximos vejam seu negócio."
  },
  {
    number: "3",
    title: "Gerenciar",
    ...
    <section className="py-16 sm:py-20 lg:py-24 2xl:py-32 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl 2xl:text-6xl font-bold text-[#3c4043] mb-4 sm:mb-6">
          Mostre o melhor do seu negócio
        </h2>
